...
function LiveTemplateExperience({ domainDisplay }: { domainDisplay: string }) {
  const EXP = [
        ...
        <div className="texp-stage" ref={stageRef} style={{flex:1,minWidth:0}}>
          ...
          >
            <div className="texp-chrome">
              ...
              {device !== 'mobile' && (
                <span className="texp-chrome-url">{domainDisplay}/<em>yourName</em> </span>
              )}
...
function TemplateShowcase({ onPreview, domainDisplay }: { onPreview: (t: typeof TMPLS[0]) => void; domainDisplay: string }) {
...
return (
  <section id="templates" className="tshow">
...
>
            ...
            <div className="tshow-iframe-url">{domainDisplay}/{cur.id}</div>
...
// original hardcoded copy, so the homepage renders byte-for-byte what it
...
export default function HomeClient({ tenant = DEFAULT_HOME_TENANT }: { tenant?: HomeTenant } = {}) {
  ...
  useEffect(()=>{
    const timer = setTimeout(() => {
      ...
      // immediately reveal anything already in view (above the fold)
      ...
      <section className="hero-main" id="hero">
        <div className="hero-main-inner">
          ...
          {/* <div className="hero-main-visual">
            ...
            <LiveTemplateExperience domainDisplay={domainDisplay}/>


      <TemplateShowcase onPreview={setPreviewT} domainDisplay={domainDisplay}/>
                        ...
                        <div className="td-card-foot">
                          ...
                          {fee != null && fee > 0 && (
                            <div className="td-card-fee">
                              <span className="td-card-fee-n">{tenant.currencySymbol}{fee.toLocaleString('en-IN')}</span>
      ...
      <section id="faq" className="faq-section">
        ...
        <div className="faq-wrap">
          ...
          <div className="faq-list rv" style={{transitionDelay:'.08s'}}>
            {[
              {
                q: `Who can list a practice on ${tenant.brandName}?`,
