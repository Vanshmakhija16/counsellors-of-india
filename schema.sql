...
\restrict BLDl2oytcNlMUCzX2JJOZt5odDsuuG5ubgsy6gvmPAJhIMIA7eTRcK0jLqG5883
...
begin
  ...
  values (
    new.id,
    coalesce(new.raw_user_meta_data->>'full_name', 'New Therapist'),
    new.email,
...
--
-- Name: objects authenticated reads clinical-resources; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "authenticated reads clinical-resources" ON storage.objects FOR SELECT USING (((bucket_id = 'clinical-resources'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects authenticated writes clinical-resources; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "authenticated writes clinical-resources" ON storage.objects FOR INSERT WITH CHECK (((bucket_id = 'clinical-resources'::text) AND (auth.role() = 'authenticated'::text)));
...
--
-- Name: objects avatars public upload; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "avatars public upload" ON storage.objects FOR INSERT WITH CHECK ((bucket_id = 'avatars'::text));
...
\unrestrict BLDl2oytcNlMUCzX2JJOZt5odDsuuG5ubgsy6gvmPAJhIMIA7eTRcK0jLqG5883
